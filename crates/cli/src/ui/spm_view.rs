...
impl SpmView {
    ...
    pub fn update(&mut self, message: Message) {
        match message {
            ...
            Message::GenerateSPM => {
                ...
                if self.changelog { files.push("Changelog"); }
    ...
    fn header_view(&self) -> AppElement<'_> {
        column![
            ...
            .height(20),
            center_x(
                text("Command Line Tools for macOS to create Swift Package Manager projects with desirable files.")
                    .color(Color::WHITE)
                    .size(14)
            )
            .padding(16),
    ...
    fn files_title_view(&self) -> AppElement<'_> {
        ...
        iced::widget::Container::new(title)
            .padding([0, 24])
            .into()
    }
