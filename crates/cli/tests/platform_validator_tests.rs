...
fn test_generate_platform_ios() {
	...
	let _ = PlatformValidator::generate_platform(project_name, vec!["iOS"], false);
...
fn test_generate_platform_macos() {
	...
	let _ = PlatformValidator::generate_platform(project_name, vec!["macOS"], false);
...
fn test_generate_platform_with_plugin() {
	...
	let _ = PlatformValidator::generate_platform(project_name, vec!["iOS"], true);
